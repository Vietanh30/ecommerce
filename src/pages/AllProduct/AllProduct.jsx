                    ...
                    <div className="px-8">
                        <div className="flex justify-between items-center mt-6">
                            ...
                            <button className="rounded bg-[#232321] py-3 px-4 flex gap-3 items-center hover:bg-black">
                                ...
                                <Link to={path.addProduct} className="text-white font-medium text-sm">Thêm mới sản phẩm</Link>
                            </button>
                        </div>
                        <div className="mt-8">
                                    ...
                                    >
                                        <div className="flex flex-col gap-4">
                                                ...
                                                <div className="flex flex-col justify-between">
                                                    ...
                                                    <div>
                                                        <div className="font-semibold text-xs">
                                                            <span className="opacity-75">Giá nhập:</span> ${product.cost_price}
                                                        </div>
                                                        <div className="mt-1 font-semibold text-xs">
                                                            <span className="opacity-75">Giá bán:</span> ${product.selling_price}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="border rounded-lg p-4">
                                                ...
                                                <div className="flex justify-between">
                                                    <div className="text-sm font-medium">Sản phẩm tương tự</div>
