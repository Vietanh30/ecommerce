...
import yellow from '../../../assets/Product/starYellow.svg'
import gray from '../../../assets/Product/starGray.svg'
import half from '../../../assets/Product/starHalf.svg'
const Star = ({ type }) => {
  const starImages = {
    yellow: yellow,
    gray: gray,
  ...
  return (
    <img
      ...
      alt={`${type} star`}
      style={{ width: '20px', height: '20px', marginRight: '4px' }} // Bạn có thể thay đổi kích thước ở đây
    />
  );
};
